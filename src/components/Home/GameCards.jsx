...
const GameCards = () => {
  return (
    <div
      className={`bg-[#1272E0] px-4 py-4 w-full max-w-[400px] text-white rounded-lg shadow-2xl lg:py-7 lg:px-6 `}
    >
      <div className="flex justify-between items-center">
        <h3 className="text-2xl font-semibold">Pick 1</h3>
        <p className="py-1 px-4 border border-white rounded-2xl">AED 5</p>
      </div>
      <p className="mt-7 lg:mt-9 text-center ">
